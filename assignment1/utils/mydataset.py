...
class Dataset:
    ...
    # 初始化 分词后的sentence、每个sentence的长度、每个sentence的第一个单词相对于起始位置的index
    def sentences(self):
        ...
        self._cumsentlen = np.cumsum(self._sentlengths)  # 累加
    ...
    def sent_labels(self):
        ...
        labels = [0.0] * phrases  # [情感值]，下标为句子id
